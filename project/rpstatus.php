...
// คำสั่ง SQL เพื่อดึงข้อมูลนักเรียนและเปอร์เซ็นต์
$sql = "SELECT id, first_name, last_name, class, student_id, COALESCE(percentage, 0) as percentage
        FROM std_dt";
...
<body>
    <div class="container">
        ...
        <p>เปอร์เซ็นต์การเข้าแถวของนักเรียน</p>
        <table>
            <thead>
                <tr>
                    <th>เลขที่</th>
