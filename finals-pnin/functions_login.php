<?php 
    ...
    define('DB_NAME', 'register_db'); // Database Name
    ...
    class DB_con {
        ...
        public function useremailavailable($uemail) {
            $checkuser = mysqli_query($this->dbcon, "SELECT username FROM tblusers WHERE username = '$uemail'");
            return $checkuser;
        }
